      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Our streamlined process makes finding your dream job easier than ever.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Use our advanced search filters to find jobs that match your skills, location, and career goals."
            index={0}
          />
          <FeatureCard
            ...
            description="Submit applications quickly with our one-click apply feature and track your progress in real-time."
            index={1}
          />
          <FeatureCard
            ...
            title="Get Connected"
            description="Connect with hiring managers and get personalized job recommendations based on your profile."
            index={2}
          />
          <FeatureCard
            ...
            description="Access interview tips, salary insights, and company information to ace your job interviews."
            index={3}
          />
          <FeatureCard
            ...
            description="Negotiate offers confidently with our salary data and career guidance from industry experts."
            index={4}
          />
          <FeatureCard
            ...
            description="Continue your professional journey with ongoing career development resources and networking opportunities."
            index={5}
          />
        </div>
      </div>
