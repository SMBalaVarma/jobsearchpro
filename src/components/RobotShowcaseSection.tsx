        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
              ...
              <span>Treffen Sie die Zukunft</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              Präzisionstechnik trifft auf <span className="text-[#FC4D0A]">Adaptive KI</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Unser humanoider Roboter repräsentiert die perfekte Verschmelzung von modernster 
              Maschinenbautechnik und fortschrittlicher künstlicher Intelligenz, entworfen um nahtlos 
              in menschliche Umgebungen zu integrieren.
            </p>
          </div>
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Begleiter der nächsten Generation</h3>
                  <p className="text-white/80">Entwickelt für menschliche Interaktion</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Erweiterte Sensoren</h4>
              <p className="text-gray-600">Hochpräzise Sensoren bieten Echtzeit-Umgebungswahrnehmung und Objekterkennung.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-600">Lernt kontinuierlich aus Interaktionen, um die Leistung zu verbessern und Antworten zu personalisieren.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Fließende Bewegungen</h4>
              <p className="text-gray-600">Entwickelt für natürliche, menschenähnliche Bewegungen mit hohem Freiheitsgrad in allen Gelenken.</p>
            </div>
          </div>
        </div>
      </div>
