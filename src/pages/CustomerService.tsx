...
import { Headphones, Users, Building, MapPin, Clock, Euro } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-teal-100 text-teal-700 px-4 py-2 rounded-full mb-6">
                ...
                <span className="font-medium">Kundendienst Karrieren</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Exzellenz im <span className="text-teal-600">Kundendienst</span>
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Entdecken Sie spannende Möglichkeiten im Support, der Kundenbetreuung und Kundenerfahrung. 
                Helfen Sie dabei, außergewöhnliche Kundenerlebnisse zu schaffen.
              </p>
