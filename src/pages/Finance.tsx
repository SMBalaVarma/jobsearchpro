...
import { DollarSign, Users, Building, MapPin, Clock, Euro } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-yellow-100 text-yellow-700 px-4 py-2 rounded-full mb-6">
                ...
                <span className="font-medium">Finanz Karrieren</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Ihre Zukunft in der <span className="text-yellow-600">Finanzwelt</span>
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Entdecken Sie spannende Karrieremöglichkeiten im Banking, der Buchhaltung und 
                Finanzdienstleistungen. Gestalten Sie die Finanzwelt von morgen mit.
              </p>
              
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <Badge variant="secondary" className="px-4 py-2">
                  <Users className="h-4 w-4 mr-2" />
                  1.456 offene Stellen
                </Badge>
                <Badge variant="secondary" className="px-4 py-2">
