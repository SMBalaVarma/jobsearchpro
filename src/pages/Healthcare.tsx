...
import { Heart, Users, Building, MapPin, Clock, Euro } from "lucide-react";
...
const Healthcare = () => {
  const healthcareJobs = [
    ...
    {
      id: 2,
      title: "Arzt/Ärztin Innere Medizin",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-green-100 text-green-700 px-4 py-2 rounded-full mb-6">
                ...
                <span className="font-medium">Gesundheitswesen Karrieren</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Ihre Karriere im <span className="text-green-600">Gesundheitswesen</span>
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Finden Sie bedeutungsvolle Positionen in der Medizin, Pflege und Gesundheitsverwaltung. 
                Machen Sie einen Unterschied in der Gesundheitsversorgung.
              </p>
              
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <Badge variant="secondary" className="px-4 py-2">
                  <Users className="h-4 w-4 mr-2" />
                  1.923 offene Stellen
                </Badge>
                <Badge variant="secondary" className="px-4 py-2">
